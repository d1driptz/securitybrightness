...
| User-facing SecurityBrightness application | A usable place to see connected applications, granted authority, proposed effects, pending review, explanations, recent decisions and revocation controls. | A minimal trusted-operator desktop review window exists; application/permission management and an application-facing asynchronous review backend do not. |
