...
| User-facing SecurityBrightness application | Inspect connected applications, authority, proposals, review, explanations, history and revocation. | Desktop review, stored/active authority inspection, confirmed revocation and exact-version persistent-grant unlock exist; broader management, history and asynchronous review remain planned. |
