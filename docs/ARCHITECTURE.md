...
| Policy denial, missing-scope denial before prompting, approval and strong confirmation | [permissions.py](../core/permissions.py), [approval.py](../core/approval.py) | [test_permissions.py](../core/test_permissions.py), [test_approval.py](../core/test_approval.py), [test_approval_security.py](../core/test_approval_security.py). Terminal review is synchronous; providers are trusted code, not verified human identity. |
